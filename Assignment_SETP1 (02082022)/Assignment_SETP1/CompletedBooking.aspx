...
<br />
   ...
   <asp:TextBox ID="TextBox1" runat="server" Height="24px" Width="90%" placeholder="Search.." OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        ...
        <div class="tablesection">
            <asp:GridView ID="GridView1" runat="server" CssClass="mybookingdatagrid" PagerStyle-CssClass="bookingpager" EmptyDataRowStyle-CssClass="emptytable"
 HeaderStyle-CssClass="bookingheader" RowStyle-CssClass="bookingrows" AllowPaging = "True" OnPageIndexChanging = "OnPaging" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="8" ShowHeaderWhenEmpty="True">
                <Columns>
