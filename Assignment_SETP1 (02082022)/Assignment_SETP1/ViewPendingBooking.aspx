<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPendingBooking.aspx.cs" Inherits="Assignment_SETP1.ViewPendingBooking" %>
...
<br />
       <div class="viewbookingtable">
           <table class="auto-style1">
               <tr>
                   <td class="tableheader" colspan="3">Pending Booking</td>
               </tr>
               ...
               <tr>
                   <td class="bookingtitle2">Amount ($)</td>
                   <td class="bookingtitle2">Status</td>
                   <td class="auto-style23"></td>
               </tr>
               <tr>
                   <td class="textboxtoadjust">
                       <asp:TextBox ID="TextBoxamount" runat="server" Width="320px" disabled="disabled"></asp:TextBox>
                   </td>
                   <td class="statusbar">
                       <asp:DropDownList class="statusdropdown" ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack = "true" Height="38px" Width="253px">
               ...
               <tr>
                   ...
                   <td class="tdcancelandupdatebutton">
                       <asp:LinkButton CssClass="cancelbutton1" ID="CancelButton2" runat="server" OnClick="cancelbutton2_Click">Cancel</asp:LinkButton>
&nbsp;&nbsp;&nbsp;
                       <asp:LinkButton CssClass="updatebutton1" ID="UpdateButton2" runat="server" OnClick="updatebutton2_Click">Update</asp:LinkButton>
                   </td>
               </tr>
           </table>
           </div>
