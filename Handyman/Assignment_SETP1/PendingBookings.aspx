<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingBookings.aspx.cs" Inherits="Assignment_SETP1.PendingBookings" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <li style="width:220px;"><a href="PendingBookings.aspx" style="color:#4169E1;"><img src="calendar (1).png" width="50" height="50"/><br />Pending Bookings</a></li>
...
<br />
   ...
   <asp:TextBox ID="TextBox1" runat="server" Height="24px" Width="90%" placeholder="Search.." OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <asp:Button ID="SearchButton2" runat="server" Text="Search" CssClass="button" OnClick="SearchButton2_Click"  /> 
        </div> 
        <br />-->
            <!--table-Gridview-->
 ...
 HeaderStyle-CssClass="bookingheader" RowStyle-CssClass="bookingrows" AllowPaging = "True" OnPageIndexChanging = "OnPaging" AutoGenerateColumns="False" CellPadding="8">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action" >
                        <ItemTemplate>
                            <asp:LinkButton ID="ViewButton2" runat="server" CssClass="viewbutton" Text="View" OnCommand="ViewButton2_Click" CommandName="view" CommandArgument='<%# Eval("bookingref")%>'>
