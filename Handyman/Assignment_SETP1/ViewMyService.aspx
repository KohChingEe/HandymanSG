<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewMyService.aspx.cs" Inherits="Assignment_SETP1.ViewMyService" %>
...
<br />
       <div class="viewservicetable">
           <table class="auto-style1">
               <tr>
                   <td class="viewservicetableheader" colspan="3">My Service</td>
               </tr>
               ...
               <tr class="viewservicetitlerow3">
                   <td class="viewservicetitle3">Service ID</td>
                   <td class="viewservicetitle3">Title</td>
                   <td class="viewservicetitle3">Description</td>
               </tr>
               <tr>
                   <td class="textboxtoadjust2">
                       <asp:TextBox ID="TextBoxserviceID" runat="server" CssClass="auto-style24" Width="320px" disabled="disabled"></asp:TextBox>
                   </td>
                   <td class="textboxtoadjust2">
                       <asp:TextBox ID="TextBoxtitle" runat="server" Width="320px" disabled="disabled"></asp:TextBox>
                   </td>
               ...
               <tr>
                   ...
                   <td class="textboxtoadjust2"></td>
                   <td class="textboxtoadjust2"></td>
               </tr>
               <tr class="unusedviewservicerow3">
                   <td class="auto-style11"></td>
                   <td class="auto-style17"></td>
                   <td class="auto-style21"></td>
               </tr>
               <tr>
                   ...
                   <td class="tdcancelandupdatebutton2">
                       <asp:LinkButton CssClass="cancelbutton2" ID="CancelButton3" runat="server" OnClick="cancelbutton3_Click">Cancel</asp:LinkButton>
&nbsp;&nbsp;&nbsp;
                       <asp:LinkButton CssClass="updatebutton2" ID="UpdateButton3" runat="server" OnClick="updatebutton3_Click">Update</asp:LinkButton>
                   </td>
               </tr>
           </table>
           </div>
